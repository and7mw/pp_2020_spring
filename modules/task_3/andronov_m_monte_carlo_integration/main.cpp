...
//TEST(MonteCarloIntegration, performance) {
//    const size_t dims = 3;
//    std::function<double(const std::vector<double>&)> integrand =
//        [](const std::vector<double>& points)
//    { return pow(points[0], 2) * points[2] * sin(points[0] * points[1] * points[2]); };
...
//    SeqMonteCarloIntegration(integrand, intervals, N);
//    double end_seq = omp_get_wtime();
//    std::cout << "Seq: " << end_seq - start_seq << std::endl;
//
//    double start_omp = omp_get_wtime();
//    ParallelMonteCarloIntegration(integrand, intervals, N);
//    double end_omp = omp_get_wtime();
//    std::cout << "Parallel: " << end_omp - start_omp << std::endl;
//   
//}
